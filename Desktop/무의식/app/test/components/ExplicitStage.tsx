...
export default function ExplicitStage({ onComplete }: ExplicitStageProps) {
    ...
    if (phase === 'PRIMING') {
        return (
            <div className="h-full flex flex-col items-center justify-center p-8 relative overflow-hidden bg-[#FBFBFE] font-sans-kr">
                ...
                <div className="w-full max-w-lg space-y-12 relative z-10 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="pt-8 opacity-0 animate-in fade-in delay-700 duration-1000 fill-mode-forwards">
                        <button
