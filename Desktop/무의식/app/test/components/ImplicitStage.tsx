...
export default function ImplicitStage({ onComplete }: ImplicitStageProps) {
    ...
    return (
        <div className="h-full flex flex-col bg-[#F6F6F9] overflow-hidden font-sans-kr relative">
            ...
            <div className="fixed top-0 left-0 right-0 h-20 bg-white/50 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-8 z-50">
                <div className="flex flex-col">
                    <span className="text-[10px] font-black tracking-[0.3em] text-gray-400 uppercase">Gallery Exhibition</span>
                    <span className="text-sm font-bold text-gray-900">Projective Image Test</span>
                </div>
                <div className="flex items-center gap-6">
                    ...
                    <div className="text-[10px] font-black text-gray-300 tracking-widest uppercase bg-gray-50 px-3 py-1.5 rounded-sm">
            ...
            <main className="flex-1 flex flex-col pt-24 overflow-y-auto">
                ...
                <div className="flex-[1.2] flex items-center justify-center p-8 relative overflow-hidden min-h-[400px]">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {/* The Frame */}
                            <div className="bg-white p-4 md:p-6 shadow-[0_40px_70px_-15px_rgba(0,0,0,0.15)] rounded-[2px] border-[12px] border-white ring-1 ring-black/5">
                                <div className="relative overflow-hidden group">
                                    <div className="absolute inset-0 bg-black/5 pointer-events-none z-10" /> {/* Inner shadow */}
                                    <img
                                        src={currentImage.src}
                                        alt="Psychological Projection"
                                        className="max-h-[35vh] md:max-h-[45vh] w-auto h-auto object-cover transition-transform duration-[60s] ease-linear scale-110 group-hover:scale-100"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="mt-8 flex justify-center">
                                <motion.div
                                    ...
                                    className="bg-white/80 backdrop-blur-sm border border-gray-100 px-4 py-2 rounded shadow-sm text-center"
                                >
                                    <span className="block text-[8px] font-black text-gray-300 tracking-[0.2em] uppercase mb-0.5">Exhibit No.</span>
                                    <span className="text-[11px] font-bold text-gray-500 font-serif-kr">Untitled Perception {currentImageIndex + 1}</span>
                                </motion.div>
                            </div>
                ...
                <div className="flex-1 bg-white rounded-t-[3.5rem] shadow-[0_-20px_60px_rgba(0,0,0,0.03)] px-8 pt-10 pb-12 flex flex-col items-center">
                            ...
                            <div className="flex flex-col items-center gap-10">
                                ...
                                <div className="w-full flex justify-between items-center px-4">
                                    <div className="flex flex-col items-start gap-1">
                                        <span className="text-[10px] font-black text-gray-300 tracking-[0.4em] uppercase">Not at all</span>
                                        <span className="text-[12px] font-bold text-gray-400">전혀 아니다</span>
                                    </div>
                                    <div className="text-[10px] font-black text-black/20 tracking-widest bg-gray-50 px-4 py-1.5 rounded-full border border-gray-100 italic">
                                        1 ~ 5 Selection
                                    </div>
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-[10px] font-black text-gray-300 tracking-[0.4em] uppercase">Very much</span>
                                        <span className="text-[12px] font-bold text-gray-400">매우 그렇다</span>
                                    </div>
                                </div>
                            </div>
                        </div>
