...
export const TestData = {
    ...
    explicitQuestions: [
        "나는 도전적인 목표를 세우고 그 목표에 도달했을 때 스스로 **유능하다는 경험**을 하고 싶다.",
        "나는 나의 목표가 다른 사람들보다 **더 뛰어난 결과**를 가져오는 것을 보여주고 싶다.",
        "나는 나의 목표를 통해 **높은 수준의 기준과 우수성**을 달성하는 것에 집중한다.",
        "나는 목표 달성 과정을 통해 **그룹 내에서 주도적인 역할**을 맡아 영향력을 행사하고 싶다.",
        "나는 나의 목표가 **권위 있는 위치나 지위** 획득에 기여하기를 바란다.",
        "나는 목표 추구를 통해 **다른 사람들의 결정이나 행동**에 성공적으로 영향을 미치고 싶다.",
        "나는 목표를 통해 타인과 **따뜻하고 친밀한 관계**를 유지하는 것을 중요하게 생각한다.",
        "나는 목표 달성 과정에서 사람들과 어울리며 깊은 **소속감**을 느끼고 싶다.",
        "나는 타인과의 관계에서 **조화롭고 협력적인 태도**를 유지하는 것을 목표로 한다."
    ],
    ...
    wellbeingQuestions: [
        ...
        "나는 목표는 주로 타인의 인정을 받거나 사회적 지위를 높이기 위한 것이다"
    ]
};
